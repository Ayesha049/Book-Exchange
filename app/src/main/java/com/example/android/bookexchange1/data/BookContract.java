...
public class BookContract {
    ...
    public static final class PersonEntry implements BaseColumns {
        ...
        public static final Uri PERSON_URI = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_PERSON);
        public final static String PERSON_TABLE_NAME = "person";
        public final static String PERSON_ID = BaseColumns._ID;
        public final static String COLUMN_PERSON_FIRSTNAME ="first name";
        public final static String COLUMN_PERSON_LASTNAME ="last name";
    ...
    public static final class AdvertisementEntry implements BaseColumns {
        ...
        public static final Uri PERSON_URI = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_ADVERTISEMENT);
        public final static String AD_TABLE_NAME = "advertisements";
        public final static String AD_ID = BaseColumns._ID;
        public final static String COLUMN_AD_BOOK_NAME ="book name";
        public final static String COLUMN_AD_AUTHOR_NAME ="author name";
        ...
        public final static String COLUMN_AD_PERSON_ID ="id";
    ...
    public static final class OrderlistEntry implements BaseColumns {
        ...
        public static final Uri PERSON_URI = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_ORDERLIST);
        public final static String ORDER_TABLE_NAME = "orders";
        public final static String ORDER_ID = BaseColumns._ID;
        public final static String ORDER_PERSON_ID = "id";
